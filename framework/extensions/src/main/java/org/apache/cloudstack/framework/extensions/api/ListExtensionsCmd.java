...
public class ListExtensionsCmd extends BaseListCmd {
    ...
    @Parameter(name = ApiConstants.TYPE, type = CommandType.STRING, description = "Type of the extension (e.g. NetworkOrchestrator)")
    private String type;

    @Parameter(name = ApiConstants.RESOURCE_ID, type = CommandType.STRING,
            description = "ID of the resource to list registered extensions for (e.g. physical network UUID)")
    private String resourceId;

    @Parameter(name = ApiConstants.RESOURCE_TYPE, type = CommandType.STRING,
            description = "Type of the resource (e.g. PhysicalNetwork, Cluster)")
