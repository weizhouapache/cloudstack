...
@APICommand(name = "deleteVnfBroker",
        description = "Deletes an existing Vnf broker.",
    ...
    public void execute() {
        try {
            ...
            if (result) {
                ...
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to delete Vnf broker:" + getId());
            }
